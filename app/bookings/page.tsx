    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-4">Reservation & Booking System</h1>
          <p className="text-lg text-muted-foreground mb-10">
            Let guests reserve tables or rooms online with less back-and-forth and fewer booking mistakes.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            {[
              'Table booking and room inquiry forms',
              'Date and time slot availability',
              'Automatic confirmation messages',
              'Reminder notifications before check-in/visit',
              'Dashboard view for your front-desk staff',
              'Easy cancellation and rescheduling handling',
            ].map((item) => (
          ...
          <div className="rounded-xl border border-border bg-muted/30 p-6 mb-8">
            ...
            <p className="text-muted-foreground">Restaurants managing peak dining hours and hotels wanting more direct room reservations.</p>
          </div>
