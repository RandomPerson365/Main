...
const plans = [
  ...
  },
  {
    ...
    includes: ['Everything in Starter', 'Online ordering OR reservations', 'Basic staff dashboard'],
  },
  {
    name: 'Business Plus',
    price: '₹1,00,000',
    bestFor: 'Hotels and established brands',
    includes: ['Everything in Growth', 'Ordering + bookings together', 'Payment link integration', 'Priority support', 'Monthly optimization review'],
  },
];
